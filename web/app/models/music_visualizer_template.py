"""Model para templates salvos do Music Visualizer."""
...
class MusicVisualizerTemplate(Base):
    """Configuração reutilizável do Music Visualizer, sem arquivos."""

    __tablename__ = "music_visualizer_templates"
